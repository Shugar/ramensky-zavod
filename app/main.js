...
/////////////// MAP
    ...
    function initialize() {
    var locations = [
        ['Мы тут!', 55.56365, 38.243608, 19]
    ];

    //Setup map
    map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 17,
        center: new google.maps.LatLng(55.56365, 38.243608), 
    ...
    $('.info').click(function(){
      $('.block').find('.more').slideToggle(250, "easeInOutQuint", function () {
        // Animation complete.
      });
    });
...
$(document).ready(function(){
    $('.pre-product').find('.one').click(function(){
        $(this).addClass('active');
        $('.two').removeClass('active');
    });
    $('.pre-product').find('.two').click(function(){
        $(this).addClass('active');
...
$(document).ready(function(){
    ...
    // var BV = new $.BigVideo({container: $('.slide-0')});
    // BV.init();
    // if (Modernizr.touch) {
